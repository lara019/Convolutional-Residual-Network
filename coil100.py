...
from load import load_cifar10, load_coil100
...
def trainCoil100(res_model):
	print('test trainCoil100: ' + str(res_model))

	(x_train, y_train, x_val), (x_test, y_test, y_val) = load_coil100()
